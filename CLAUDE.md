...
Agented — bot automation platform. Litestar backend + Vue 3 frontend. Manages AI bots that execute CLI tools (Claude, OpenCode) via webhooks, GitHub events, schedules, or manual triggers. Also manages products, projects, teams, agents, plugins, skills, hooks, commands, and rules.
