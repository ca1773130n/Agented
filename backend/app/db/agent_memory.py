...
# `embed_and_store`, `vector_recall`, and `hybrid_recall` moved to
# backend.app.services.embedding_service in v0.7.2 — the DB layer no
# longer imports a service. Callers should import from
# `app.services.embedding_service` directly.
