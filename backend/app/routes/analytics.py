"""Analytics API endpoints for cost, execution, and effectiveness data."""
...
def get_cost_analytics():
    """Get aggregated cost analytics grouped by period and entity."""
...
def get_execution_analytics():
    """Get aggregated execution analytics with volume, success/failure, and duration."""
    group_by = request.args.get("group_by", "day")
    start_date = request.args.get("start_date")
    end_date = request.args.get("end_date")
