...
class TestRecordRequest:
    def test_increments_counter_and_histogram(self):
        ...
        assert 'agented_http_requests_total{method="GET",path_prefix="/api/other",status="200"} 2' in text
        assert 'agented_http_requests_total{method="GET",path_prefix="/api/other",status="500"} 1' in text
