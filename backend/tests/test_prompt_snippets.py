...
def test_resolve_snippets_basic(isolated_db):
    ...
    add_snippet(name="greeting", content="Hello World")
...
def test_resolve_snippets_nested(isolated_db):
    ...
    add_snippet(name="inner", content="nested value")
    add_snippet(name="outer", content="prefix {{inner}} suffix")
...
def test_resolve_snippets_circular(isolated_db):
    ...
    add_snippet(name="circA", content="see {{circB}}")
    add_snippet(name="circB", content="see {{circA}}")
