...
Plans:
- [ ] 01-01-PLAN.md — Backend app_meta table, migration 96, /health/instance-id endpoint, XState v5 machine definition with all states/events/guards
- [ ] 01-02-PLAN.md — useTourMachine composable with localStorage persistence, instance_id validation, guard API checks, z-index CSS scale in App.vue
