<!--
  AnomalyDetectionCard — extracted from ExecutionAnomalyDetection.vue
...
function anomalyIcon(type: AnomalyType['type']): string {
  return { duration: '⏱', output_length: '📏', finding_spike: '📈', error_rate: '💥' }[type];
}
...
.anomaly-section, .baseline-section {
...
.section-header h3 { display: flex; align-items: center; gap: 8px; font-size: 0.95rem; font-weight: 600; color: var(--text-primary); margin: 0; }
.section-header h3 svg { width: 16px; height: 16px; color: var(--accent-cyan); }
.toggle-label { display: flex; align-items: center; gap: 6px; font-size: 0.82rem; color: var(--text-secondary); cursor: pointer; }
...
.anomaly-card {
  ...
  border: 1px solid var(--border-default); border-left: 3px solid;
  border-radius: 8px; display: flex; flex-direction: column; gap: 10px;
  transition: opacity 0.2s;
}
.anomaly-card.acknowledged { opacity: 0.55; }
.anomaly-top { display: flex; justify-content: space-between; align-items: flex-start; gap: 12px; flex-wrap: wrap; }
...
.severity-badge { font-size: 0.7rem; font-weight: 700; padding: 3px 10px; border-radius: 10px; border: 1px solid; text-transform: uppercase; }
.ack-badge { font-size: 0.7rem; font-weight: 600; padding: 3px 10px; border-radius: 10px; background: var(--bg-elevated); color: var(--text-tertiary); }
.anomaly-desc { font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5; margin: 0; }
.anomaly-values { display: flex; align-items: center; gap: 16px; padding: 12px 16px; background: var(--bg-elevated); border-radius: 6px; flex-wrap: wrap; }
...
.anomaly-footer { display: flex; justify-content: space-between; align-items: center; gap: 10px; }
.exec-link { font-size: 0.78rem; color: var(--text-tertiary); font-family: monospace; }

.baseline-section h3 { font-size: 0.95rem; font-weight: 600; color: var(--text-primary); margin: 0 0 6px; }
.baseline-desc { font-size: 0.82rem; color: var(--text-tertiary); margin: 0 0 16px; }
.baseline-table { display: flex; flex-direction: column; }
.baseline-head {
  display: grid; grid-template-columns: 1fr repeat(5, 110px); gap: 8px;
  padding: 8px 12px; font-size: 0.7rem; font-weight: 600; color: var(--text-tertiary);
  text-transform: uppercase; letter-spacing: 0.04em; border-bottom: 1px solid var(--border-default);
}
.baseline-row {
  display: grid; grid-template-columns: 1fr repeat(5, 110px); gap: 8px;
  padding: 10px 12px; font-size: 0.82rem; color: var(--text-secondary);
  border-bottom: 1px solid var(--border-default); align-items: center;
}
