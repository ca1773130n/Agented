      ...
      >
        ...
        <div class="sa-actions">
          <button
            ...
            @click.stop.prevent="toggleEnabled(sa, $event)"
          >
            {{ sa.enabled ? t('superAgents.disable') : t('superAgents.enable') }}
          </button>
          <button class="btn btn-sm btn-secondary" @click.stop.prevent="router.push({ name: 'super-agent-playground', params: { superAgentId: sa.id } })">
          ...
          <button
            ...
            @click.stop.prevent="router.push({ name: 'super-agent-inspector', params: { superAgentId: sa.id } })"
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14">
              <circle cx="11" cy="11" r="8"/>
          ...
          <button
            ...
            @click.stop.prevent="openOuroborosDialog(sa)"
          >
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14">
              <path d="M21 12a9 9 0 1 1-3.5-7.1"/>
              <polyline points="21 4 21 9 16 9"/>
            </svg>
            {{ t('superAgents.ouroboros') }}
          </button>
          <button class="btn btn-sm btn-danger" @click.stop.prevent="confirmDelete(sa)">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
