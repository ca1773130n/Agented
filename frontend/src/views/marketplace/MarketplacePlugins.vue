...
useWebMcpTool({
  name: 'agented_marketplace_plugins_get_state',
  description: 'Returns the current state of the Marketplace Plugins tab',
  page: 'MarketplacePlugins',
  execute: async () => ({
    content: [{
      type: 'text' as const,
      text: JSON.stringify({
  ...
  <div class="marketplace-pane">
    ...
    <Teleport to="body">
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="modal-title-plugin-detail"
        tabindex="-1"
