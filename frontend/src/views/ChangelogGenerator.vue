...
const dateTo = ref('2026-03-06');
const milestone = ref('');
const isGenerating = ref(false);
const generated = ref<string | null>(null);
const isCopied = ref(false);

const MOCK_CHANGELOG = `# Changelog — v0.4.0 (March 2026)

## Features
- **Bot Dry Run** — Execute bots against synthetic payloads without side effects (#142)
- **Natural Language Bot Creator** — Describe what you want in plain English, AI generates config (#138)
- **Execution Replay & Diff** — Compare two execution outputs side-by-side (#135)
- **Webhook Recorder** — Capture and replay webhook payloads for debugging (#133)
- **Human Approval Gates** — Require human approval before bot actions (#130)

## Improvements
- Improved context window estimation accuracy (#141)
- Prompt optimizer now detects redundant instructions (#139)
- Bot version history now shows per-field diffs (#136)
- Alert grouping now includes AI root cause analysis (#134)

## Bug Fixes
- Fixed JSON parse errors in Haiku model output (#140)
- Fixed empty stdout when {paths} placeholder is missing (#137)
- Fixed GitHub rate limit handling in PR review bot (#132)

## Security
- Secrets vault now enforces rotation reminders (#131)
- Added audit trail for all approval gate decisions (#129)

---
*Generated by Agented Changelog Bot on 2026-03-06*`;
...
async function handleGenerate() {
  ...
  try {
    ...
    generated.value = MOCK_CHANGELOG;
    showToast('Changelog generated from merged PRs', 'success');
  } catch {
...
<template>
  <div class="changelog-generator">
    ...
    <PageHeader
      ...
      subtitle="Generate AI-powered changelogs from merged pull requests."
    />
