...
export const ruleConversationApi = {
  ...
  stream: (convId: string, options?: AuthenticatedEventSourceOptions): AuthenticatedEventSource => createAuthenticatedEventSource(`${API_BASE}/api/rules/conversations/${convId}/stream`, options),
