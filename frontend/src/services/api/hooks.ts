...
export const hookConversationApi = {
  ...
  stream: (convId: string, options?: AuthenticatedEventSourceOptions): AuthenticatedEventSource => createAuthenticatedEventSource(`${API_BASE}/api/hooks/conversations/${convId}/stream`, options),
