...
<template>
  ...
  >
    <div class="sidebar-nav">
      ...
      <!-- Activity Summary — daily/weekly "what you did" digest (Tesserae) -->
      <SidebarFlatLink
        :label="t('nav.activitySummary')"
        :active="sidebarActive('activity-summary')"
        :collapsed-desktop="isCollapsedDesktop()"
        @click="navTo('activity-summary')"
      >
        <template #icon>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <!-- Knowledge Graph — Tesserae `status`+`query`: browse what Tesserae knows -->
      <SidebarFlatLink
        :label="t('nav.knowledgeGraph')"
        :active="sidebarActive('memory-graph')"
        :collapsed-desktop="isCollapsedDesktop()"
        @click="navTo('memory-graph')"
      >
        <template #icon>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <a href="/schema/swagger" target="_blank" rel="noopener noreferrer" class="external-link">
        <span class="nav-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
