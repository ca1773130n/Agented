  ...
  <div class="historical-viewer">
    ...
    <div v-else class="messages">
      ...
      >
        ...
        <MarkdownContent class="content" :content="msg.content" />
      </div>
    </div>
  </div>
</template>
...
/* Markdown styling now lives on the shared <MarkdownContent>
   component — the ``.content`` class is just a layout slot here. */
</style>
