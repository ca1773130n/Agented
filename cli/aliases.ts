...
export const ALIASES: Alias[] = [
  ...
  { group: 'mem', verb: 'sessions-import', method: 'POST', path: '/admin/system/memory/tesserae/projects/:project/sessions-import',
    params: ['project'], resolve: ['project'], render: 'raw',
    help: 'ag mem sessions-import GRD   (push sessions into the graph; distill needs this)' },
